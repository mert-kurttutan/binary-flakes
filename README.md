...
Obsidian and Zed target `x86_64-linux` and `aarch64-linux`; Codex targets only
`x86_64-linux`. The default package is Codex on x86_64 and Obsidian on
aarch64.

The hourly workflow checks Codex, Obsidian, and Zed independently with Nushell. For
